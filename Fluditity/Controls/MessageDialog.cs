...
namespace Fluid.Controls
{
    ...
    public class MessageDialog : FluidPanel
    {
        ...
        {
            base.InitControl();
            int h0 = (int)(Globals.bounds.Height * .45);

            Bounds = new Rectangle(0, 0, Globals.bounds.Width, h0);
            BackColor = Color.Black;
            ForeColor = Color.White;
            GradientFill = true;
            GradientFillOffset = 24;
            EnableDoubleBuffer = true;
            FluidButton okBtn = new FluidButton("OK", 8, h0 - 24 - 2, 100, 24);
            ...
            FluidButton cancelBtn = new FluidButton("Cancel", 240 - 100 - 8, h0 - 24 - 2, 100, 24);
            ...
            FluidLabel textLabel = new FluidLabel("", 4, 2, Width - 8, h0 - 24 - 2);
